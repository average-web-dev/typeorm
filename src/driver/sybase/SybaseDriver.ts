...
import type { SybaseDataSourceOptions } from "./SybaseDataSourceOptions"
...
export class SybaseDriver implements Driver {
     ...
     * DataSource options.
     */
    get options(): SybaseDataSourceOptions {
        return this.dataSource.options as SybaseDataSourceOptions
    }
